...
/**
 * Spring Data Jpa 적용 안한 버젼
 * */
//JUnit5의 경우 @RunWith 없어도 됨.
@SpringBootTest
@Transactional
@Rollback(false)
class MemberJpaRepositoryTest {
    ...
    public void basicCRUD(){
        ...
        long deleted = memberJpaRepository.count();
    ...
    public void findByUsernameGreaterThen(){
        ...
        List<Member> result = memberJpaRepository.findByUsernameGreaterThen("AAA", 15);
